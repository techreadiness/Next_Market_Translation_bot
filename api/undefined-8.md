...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/pt4moEMpSf4BGvjJCzQm/api/undefined-8
---
...
| ----------- | -------------------------------------------------- | ------------------------------------------------------------------------------- |
| 500         | [Error Code](undefined-8.md#error-response-format) | 서버측 상태 이상 오류입니다. 상세 정의된 응답 코드를 확인하세요.                                           |
...
| 406         | [Error Code](undefined-8.md#error-response-format) | 입력상 처리될 수 없는 요청인 경우이며 상세 정의된 응답 코드를 확인하세요.                                      |
