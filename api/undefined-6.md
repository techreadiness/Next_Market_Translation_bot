...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/pt4moEMpSf4BGvjJCzQm/api/undefined-6
---
...
**Response**\
[Error response format](undefined-8.md#error-response-format)에 맞춰 각 오류의 상세를 자체 정의할 수 있습니다. 스토어 측에서는 503 응답을 받은 경우 재시도를 반복하게 되며 403, 406, 500의 응답을 받는 경우 모니터링을 통해 복구 또는 요청을 강제 취소하는 절차를 진행하게 됩니다.
